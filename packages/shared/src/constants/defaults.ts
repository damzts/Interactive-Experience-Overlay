...
function normalizeWidgetThemeConfig(config?: Partial<WidgetThemeConfig> | null): WidgetThemeConfig {
  ...
  return {
    ...
    scrollbars: config?.scrollbars === 'hidden' ? 'hidden' : 'auto',
  }
}
...
export const DEFAULT_WIDGET_THEME_PRESETS: Record<WidgetSkinTheme, WidgetThemeConfig> = {
  metalheart:         { skin: 'metalheart',       shape: 'metalheart', fontFamily: 'Audiowide',       accentColor: '#ff5c8a', textColor: '#f8fbff', titleColor: '',        animation: 'shimmer',   atmosphere: 'sparkle',   motionIntensity: 0.95, glowIntensity: 1.2,  shellOpacity: 1,    shadowIntensity: 1.2, borderRadius: 0, scrollbars: 'auto'  },
  'genx soft club':   { skin: 'genx soft club',   shape: 'pod',       fontFamily: 'Electrolize',     accentColor: '#ff94d6', textColor: '#2c1430', titleColor: '',        animation: 'pulse',     atmosphere: 'sparkle',   motionIntensity: 1.15, glowIntensity: 0.85, shellOpacity: 1,    shadowIntensity: 0.8, borderRadius: 8, scrollbars: 'auto'  },
  chromecore:         { skin: 'chromecore',        shape: 'rect',      fontFamily: 'Rajdhani',        accentColor: '#7fe0ff', textColor: '#152433', titleColor: '',        animation: 'shimmer',   atmosphere: 'grid',      motionIntensity: 0.8,  glowIntensity: 0.95, shellOpacity: 1,    shadowIntensity: 1.0, borderRadius: 2, scrollbars: 'auto'  },
  'y2k futurism':     { skin: 'y2k futurism',      shape: 'notch-hud', fontFamily: 'Orbitron',        accentColor: '#2cf7ff', textColor: '#ebfbff', titleColor: '',        animation: 'aurora',    atmosphere: 'nebula',    motionIntensity: 1.35, glowIntensity: 1.6,  shellOpacity: 1,    shadowIntensity: 1.6, borderRadius: 4, scrollbars: 'auto'  },
  transparent:        { skin: 'transparent',       shape: 'rect',      fontFamily: 'Share Tech Mono', accentColor: '#b8f4ff', textColor: '#effcff', titleColor: '',        animation: 'broadcast', atmosphere: 'scanlines', motionIntensity: 1,    glowIntensity: 1.05, shellOpacity: 0.55, shadowIntensity: 0.4, borderRadius: 6, scrollbars: 'auto'  },
  'aqua pop':         { skin: 'aqua pop',          shape: 'blob',      fontFamily: 'Rajdhani',        accentColor: '#4ddcff', textColor: '#08374c', titleColor: '',        animation: 'shimmer',   atmosphere: 'sparkle',   motionIntensity: 1.05, glowIntensity: 1.25, shellOpacity: 0.92, shadowIntensity: 1.1, borderRadius: 10, scrollbars: 'auto' },
  'mallsoft pearl':   { skin: 'mallsoft pearl',    shape: 'blob',      fontFamily: 'Electrolize',     accentColor: '#ffb8e8', textColor: '#5a2b58', titleColor: '',        animation: 'aurora',    atmosphere: 'nebula',    motionIntensity: 0.9,  glowIntensity: 1.15, shellOpacity: 0.9,  shadowIntensity: 0.7, borderRadius: 12, scrollbars: 'auto' },
  'messenger glow':   { skin: 'messenger glow',   shape: 'rect',      fontFamily: 'Audiowide',       accentColor: '#75ffb2', textColor: '#16352a', titleColor: '',        animation: 'pulse',     atmosphere: 'grid',      motionIntensity: 1.15, glowIntensity: 1,    shellOpacity: 1,    shadowIntensity: 1.0, borderRadius: 4, scrollbars: 'auto'  },
  'limewire plasma':  { skin: 'limewire plasma',  shape: 'shard',     fontFamily: 'Share Tech Mono', accentColor: '#7aff54', textColor: '#e8ffe1', titleColor: '',        animation: 'broadcast', atmosphere: 'scanlines', motionIntensity: 1.35, glowIntensity: 1.45, shellOpacity: 1,    shadowIntensity: 1.4, borderRadius: 0, scrollbars: 'auto'  },
  'cyber y2k':        { skin: 'cyber y2k',         shape: 'notch-hud', fontFamily: 'Orbitron',        accentColor: '#ff6dff', textColor: '#f4fbff', titleColor: '',        animation: 'aurora',    atmosphere: 'grid',      motionIntensity: 1.45, glowIntensity: 1.7,  shellOpacity: 1,    shadowIntensity: 1.7, borderRadius: 2, scrollbars: 'auto'  },
  'digital futurism': { skin: 'digital futurism',  shape: 'rect',      fontFamily: 'Audiowide',       accentColor: '#56f0ff', textColor: '#eafcff', titleColor: '',        animation: 'shimmer',   atmosphere: 'nebula',    motionIntensity: 1.1,  glowIntensity: 1.35, shellOpacity: 0.95, shadowIntensity: 1.3, borderRadius: 4, scrollbars: 'auto'  },
  'ssx rush':         { skin: 'ssx rush',          shape: 'wing',      fontFamily: 'Rajdhani',        accentColor: '#ff8e2b', textColor: '#4b1322', titleColor: '',        animation: 'pulse',     atmosphere: 'sparkle',   motionIntensity: 1.55, glowIntensity: 1.2,  shellOpacity: 1,    shadowIntensity: 1.2, borderRadius: 6, scrollbars: 'auto'  },
  'ps2 drift':        { skin: 'ps2 drift',         shape: 'rect',      fontFamily: 'Electrolize',     accentColor: '#6ba4ff', textColor: '#edf3ff', titleColor: '',        animation: 'broadcast', atmosphere: 'grid',      motionIntensity: 1.1,  glowIntensity: 1.1,  shellOpacity: 1,    shadowIntensity: 1.0, borderRadius: 0, scrollbars: 'auto'  },
  'xbox blade':       { skin: 'xbox blade',        shape: 'bevel',     fontFamily: 'Share Tech Mono', accentColor: '#79ff5a', textColor: '#efffe7', titleColor: '',        animation: 'broadcast', atmosphere: 'scanlines', motionIntensity: 1.25, glowIntensity: 1.3,  shellOpacity: 1,    shadowIntensity: 1.3, borderRadius: 2, scrollbars: 'auto'  },
  'cel street':       { skin: 'cel street',        shape: 'sticker',   fontFamily: 'Audiowide',       accentColor: '#ffd447', textColor: '#1a1f2f', titleColor: '',        animation: 'pulse',     atmosphere: 'clean',     motionIntensity: 1.2,  glowIntensity: 0.9,  shellOpacity: 1,    shadowIntensity: 0.9, borderRadius: 4, scrollbars: 'auto'  },
  'aero nova':        { skin: 'aero nova',         shape: 'tv',        fontFamily: 'Rajdhani',        accentColor: '#59d7ff', textColor: '#103b58', titleColor: '',        animation: 'aurora',    atmosphere: 'sparkle',   motionIntensity: 1.05, glowIntensity: 1.45, shellOpacity: 0.88, shadowIntensity: 0.6, borderRadius: 14, scrollbars: 'auto' },
  'aero opaline':     { skin: 'aero opaline',      shape: 'tv',        fontFamily: 'Electrolize',     accentColor: '#7ceee7', textColor: '#1a4960', titleColor: '',        animation: 'shimmer',   atmosphere: 'nebula',    motionIntensity: 0.95, glowIntensity: 1.25, shellOpacity: 0.82, shadowIntensity: 0.5, borderRadius: 16, scrollbars: 'auto' },
  'dial-up candy':    { skin: 'dial-up candy',     shape: 'rect',      fontFamily: 'Trebuchet MS',    accentColor: '#58c8ff', textColor: '#20344d', titleColor: '',        animation: 'broadcast', atmosphere: 'sparkle',   motionIntensity: 1.25, glowIntensity: 1.05, shellOpacity: 1,    shadowIntensity: 0.9, borderRadius: 8, scrollbars: 'auto'  },
  'webcore flash':    { skin: 'webcore flash',     shape: 'wave',      fontFamily: 'Audiowide',       accentColor: '#ffdf3c', textColor: '#201834', titleColor: '',        animation: 'pulse',     atmosphere: 'grid',      motionIntensity: 1.4,  glowIntensity: 1.2,  shellOpacity: 1,    shadowIntensity: 1.1, borderRadius: 6, scrollbars: 'auto'  },
  'lan party':        { skin: 'lan party',         shape: 'notch-hud', fontFamily: 'Share Tech Mono', accentColor: '#67ffcc', textColor: '#e7fff7', titleColor: '',        animation: 'broadcast', atmosphere: 'scanlines', motionIntensity: 1.35, glowIntensity: 1.45, shellOpacity: 1,    shadowIntensity: 1.4, borderRadius: 0, scrollbars: 'auto'  },
  // ── Aesthetic Cartridges ──────────────────────────────────────
  'aero saint':       { skin: 'aero saint',         shape: 'tv',        fontFamily: 'Rajdhani',        accentColor: '#6fd1ff', textColor: '#083048', titleColor: '',        animation: 'aurora',    atmosphere: 'sparkle',   motionIntensity: 0.9,  glowIntensity: 1.4,  shellOpacity: 0.9,  shadowIntensity: 0.6, borderRadius: 16, scrollbars: 'auto' },
  'chrome requiem':   { skin: 'chrome requiem',     shape: 'bevel',     fontFamily: 'Audiowide',       accentColor: '#c9313a', textColor: '#f2f0ea', titleColor: '',        animation: 'broadcast', atmosphere: 'scanlines', motionIntensity: 0.9,  glowIntensity: 1.1,  shellOpacity: 1,    shadowIntensity: 1.4, borderRadius: 0, scrollbars: 'auto'  },
  'trick city':       { skin: 'trick city',         shape: 'wing',      fontFamily: 'Rajdhani',        accentColor: '#ff6b35', textColor: '#1c1c22', titleColor: '',        animation: 'pulse',     atmosphere: 'sparkle',   motionIntensity: 1.5,  glowIntensity: 1.25, shellOpacity: 1,    shadowIntensity: 1.1, borderRadius: 4, scrollbars: 'auto'  },
  'save point':       { skin: 'save point',         shape: 'codex',     fontFamily: 'Orbitron',        accentColor: '#5b7cff', textColor: '#eaf0ff', titleColor: '',        animation: 'steady',    atmosphere: 'nebula',    motionIntensity: 0.7,  glowIntensity: 1.15, shellOpacity: 1,    shadowIntensity: 1.0, borderRadius: 2, scrollbars: 'auto'  },
  'dial tone dream':  { skin: 'dial tone dream',    shape: 'blob',      fontFamily: 'Trebuchet MS',    accentColor: '#ff9ecb', textColor: '#5a2b58', titleColor: '',        animation: 'pulse',     atmosphere: 'sparkle',   motionIntensity: 1,    glowIntensity: 1,    shellOpacity: 0.92, shadowIntensity: 0.6, borderRadius: 14, scrollbars: 'auto' },
  'signal ghost':     { skin: 'signal ghost',       shape: 'rect',      fontFamily: 'Share Tech Mono', accentColor: '#ff2e88', textColor: '#e7e7ef', titleColor: '',        animation: 'broadcast', atmosphere: 'scanlines', motionIntensity: 1.2,  glowIntensity: 1.3,  shellOpacity: 1,    shadowIntensity: 1.3, borderRadius: 2, scrollbars: 'auto'  },
  'podium chrome':    { skin: 'podium chrome',      shape: 'tv',        fontFamily: 'Electrolize',     accentColor: '#f5d67a', textColor: '#2c2408', titleColor: '',        animation: 'aurora',    atmosphere: 'sparkle',   motionIntensity: 0.85, glowIntensity: 1.3,  shellOpacity: 0.94, shadowIntensity: 0.7, borderRadius: 16, scrollbars: 'auto' },
}
...
export const DEFAULT_CONFIG: AppConfig = {
  ...
  applications: [
    ...
    { id: 'winamp-window',        label: 'Winamp.exe',          icon: '🎚️',  widgetSource: 'system' as const, widgetComponent: 'winamp-window' as const,        winampWindowSettings: { randomOrder: true, autoPlay: false, intervalSec: 8 }, theme: { ...DEFAULT_WIDGET_THEME_PRESETS.metalheart, scrollbars: 'hidden' as const } },
