    ...
    <div className="taskbar">
      ...
      {activeApp && (
        <button
          ...
          onClick={() => socket.emit('scene:change', STATE.DESKTOP)}
      ...
      <div className="taskbar-tray">
        ...
        <span className="taskbar-tray-icon" title={obsConnected ? 'OBS connected' : 'OBS disconnected'}>
          <span style={{
            display: 'inline-block', width: 7, height: 7, borderRadius: '50%',
            background: obsConnected ? '#00cc00' : '#888', verticalAlign: 'middle', marginRight: 2,
          }} />
        </span>
        ...
        <button className="taskbar-tray-volume-btn" title="Volume" onClick={() => setVolumeOpen((o) => !o)}>
          🔊
        </button>
